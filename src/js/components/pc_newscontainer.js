				...
				<Row>
					...
					<Col span={20} class="container">
						<div class="leftContainer">
							...
							<PCNewsImageBlock class="tabs_news_list" count={6} type="guoji" width="400px" cartTitle="国际头条" imageWidth="110px"/>
						</div>
						...
						<div >
							<PCNewsImageBlock class="images1" count={8} type="guonei" width="100%" cartTitle="国内新闻" imageWidth="130px"/>
